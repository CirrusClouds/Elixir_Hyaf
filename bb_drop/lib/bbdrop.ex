defmodule Bbdrop do
  ...
  def call(conn, _opts) do
    ...
    |> Plug.Conn.put_resp_header("Access-Control-Allow-Methods", "GET, PUT, POST, DELETE, CREATE, HEAD, OPTIONS")
    |> Plug.Conn.put_resp_header("Access-Control-Allow-Headers", "Content-Type, Authorization, Accept, Accept-Language, X-Authorization") 
